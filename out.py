...
def logo():
  ...
  |_____/ |_| |_| |_||_.__/ |_|  Version 5.0.1""");time.sleep(0.5)
	print(c+" _____[ "+p+"Author : "+i+"Mr.Hemtkhan "+c+"]_______");time.sleep(0.3)
	print(c+"["+p+" FACEBOOK : "+i+"fb.me/Jalalzai      "+c+"]");time.sleep(0.3)
	print(c+"["+p+" WHATSAPP : "+i+"0700514406      "+c+"]");time.sleep(0.3)
