...
#Hemt khan
#Instagram:@hemtkhan
#Telegram :t.me/Hacking_by_Hemtkhan
...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;93mHemtjalalzai█████████████████▒▒▒▒▒▒▒▒..99% \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(1)
...
def action():
    ...
    jalan ("\033[1;92mHemtkhanjalalzai██████▒▒▒..99%Start Cracking...")
    ...
    jalan("Note : Your Mustafa(CP)Accounts Open after 5 to 8 days")
    print ''
    print """
...
\033[1;94mInstagram\033[1;97m∆@Hemtkhan"""
